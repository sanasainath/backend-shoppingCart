...
const BlogModel = require('./model/blog'); // Renamed import to avoid conflict
...
const blogRoutes = require('./routes/blog'); // Renamed import to avoid conflict
...
app.use('/api', order);
app.use('/api', blogRoutes); // Using renamed import
